...
public class iframe {
    ...
    public void test1() throws InterruptedException {
        ...
        driver.findElement(By.id("tinymce")).clear();
        //locate and send some texts
        driver.findElement(By.id("tinymce")).sendKeys("Dear Sir/Madam,");
        ...
        driver.findElement(By.id("tinymce")).clear();
        //locate and send some texts
        driver.findElement(By.id("tinymce")).sendKeys("AWESOME !!");
    ...
    public void multipleFrames() {
        ...
        //go upo to top level html directly
        driver.switchTo().defaultContent();
